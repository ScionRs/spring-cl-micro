package ru.tim.bill.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import ru.tim.bill.entity.Bill;
import ru.tim.bill.exception.BillNotFoundException;
import ru.tim.bill.repository.BillRepository;
...
public class BillService {
    ...
    public Bill getBillById(Long billId){
        return  billRepository.findById(billId).orElseThrow(() -> new BillNotFoundException("Unable to find bill witd id: " + billId));
    }
